...
xst -ifn xst.scr
move DivFrecppal_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DivFrecppal_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DivFrecppal_exdes.ucf DivFrecppal_exdes

echo 'Running map'
map -timing -pr b DivFrecppal_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DivFrecppal_exdes -w routed.ncd routed.vhd
cd ..
